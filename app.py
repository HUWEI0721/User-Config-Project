...
def index():
    if 'user_id' in session:
        ...
        return render_template('dashboard.html', user=user, now=datetime.utcnow())
...
def profile():
    ...
    return render_template('profile.html', user=user, login_logs=login_logs, now=datetime.utcnow())
